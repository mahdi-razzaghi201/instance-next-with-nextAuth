...
// Request
export const postTestRequestSchemaTransformed = z
  .object({
    id: z.number().int(),
    title: z
...
// Response
export const postTestResponseSchemaTransofrmed = 
  coreApiMutationResponseSchema().transform((data) => data);

export const postTestSchema = {
  request: postTestRequestSchemaTransformed,
  response: postTestResponseSchemaTransofrmed,
};
...
const inputDirectory = path.join(cwd, 'src', 'assets', 'svg-icons')
...
async function generateIconFiles() {
  ...
  const typeOutputContent = `// This file is generated by npm run gen:icons
...
\t| ${stringifiedIconNames.join('\n\t| ')}`
  ...
  if (await spriteChanged || typesChanged || readmeChanged) {
